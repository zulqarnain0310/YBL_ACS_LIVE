...
SELECT CASE WHEN  ISNULL(@DATE,'9999-01-01')<= ISNULL(@DATE1,'9999-01-01')
                     AND ISNULL(@DATE,'9999-01-01')<=ISNULL(@DATE2,'9999-01-01') THEN @DATE
            WHEN ISNULL(@DATE1,'9999-01-01')<= ISNULL(@DATE,'9999-01-01')
                     AND ISNULL(@DATE1,'9999-01-01')<=ISNULL(@DATE2,'9999-01-01') THEN @DATE1
			WHEN ISNULL(@DATE2,'9999-01-01')<= ISNULL(@DATE,'9999-01-01')
                     AND ISNULL(@DATE2,'9999-01-01')<=ISNULL(@DATE1,'9999-01-01') THEN @DATE2
