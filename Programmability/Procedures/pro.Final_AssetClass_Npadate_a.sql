...
=============================================*/
CREATE PROCEDURE [pro].[Final_AssetClass_Npadate_a]
...
UPDATE PRO.ACLRUNNINGPROCESSSTATUS 
   ...
   DROP TABLE #DD
   DROP TABLE #NPADegReason
   DROP TABLE #TempTempCo_MainBorrowerID --17102023
   DROP TABLE #TempAssetClassUCIF_ID --17102023
