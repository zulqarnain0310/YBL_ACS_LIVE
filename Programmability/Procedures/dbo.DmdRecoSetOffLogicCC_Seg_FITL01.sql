...
GO
 /*===========================================
   ...
   DESCRIPTION : DEMAND RECOVERY SET OFF
    ================================================*/
CREATE PROCEDURE [dbo].[DmdRecoSetOffLogicCC_Seg_FITL01]    
                                            -- (   
              --@TimeKey INT  
            --,@UCIF_ID VARCHAR(30)  
           -- )  
...
SET NOCOUNT ON;  
  ...
  IF OBJECT_ID('TEMPDB..#RecoveryAmtList') IS NOT NULL
	...
	AS
	(
		SELECT UCIF_ID FROM AdvAcCCDemandDetail_Seg_FITL01
			GROUP BY UCIF_ID 
	)
	  
  	SELECT ROW_NUMBER() OVER (ORDER BY A.UCIF_ID,RecDate) SrNo, A.*
        INTO #RecoveryAmtList  
     FROM AdvAcCCRecoveryDetail_Seg_FITL01 A   
      ...
      BEGIN  
         ...
         /*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/  
          ...
          SELECT   @BalRecAmt = NULL   
           ...
           SELECT @Demand_Count = COUNT(1)  
                 , @Demand_Loop = 1  
           FROM AdvAcCCDemandDetail_Seg_FITL01 DmD 
         ...
         /*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/  
                     ...
                     -- Update Recovery date, Adjustment data and Recovery amount  
                        ...
                        FROM AdvAcCCDemandDetail_Seg_FITL01 Dt_Demand  
                      ...
                      -- If the excess demand has found then insert a new row for excess demand   
                        ...
                        BEGIN  
                           ...
                           INSERT INTO AdvAcCCDemandDetail_Seg_FITL01(customerid,DemandType,DemandDate,DemandAmt,RecDate,RecAdjDate,RecAmount,BalanceDemand,DmdSchNumber,AcType,UCIF_ID,MnemonicCode)  
           ...
           -- Balance recovery update  
             ...
             FROM AdvAcCCRecoveryDetail_Seg_FITL01 Dt  
