...
IF OBJECT_ID('tempdb..##ACDAILYTXNDETAIL_MAIN') IS NOT NULL
	DROP TABLE ##ACDAILYTXNDETAIL_MAIN

select * into ##ACDAILYTXNDETAIL_MAIN from dbo.ACDAILYTXNDETAIL where TxnValueDate=@StartDate

DELETE A  from ##ACDAILYTXNDETAIL_MAIN A
...
where B.ProductCode in('660','661','889','681','682','693','694','695','696','715','716','717','718',
		       '755','756','757','758','763','764','765','766','787','788','789','795','796',
                       '797','798','799','220','237') and B.SOURCESYSTEMNAME ='FCR'
...
FROM  ##ACDAILYTXNDETAIL_MAIN
	WHERE --TxnValueDate BETWEEN @StartDate AND @EndDate 
	 NOT(ISNULL(CUSTOMERID,'')='' OR CUSTOMERID='0') 
...
from ##ACDAILYTXNDETAIL_MAIN a
	...
	inner join ##ACDAILYTXNDETAIL_MAIN b
		...
		and a.REF_CHQ_NO =b.REF_CHQ_NO    ---Add on 16-July-2020
...
/*  commented for set all BALANCE DEMAND IFTL AND NNORMAL  -- AMAR 22112020*/
----AND ISNULL(DemandDate,'1900-01-01')<>'2020-09-01' AND ISNULL(MnemonicCode,'')<>'8001'
