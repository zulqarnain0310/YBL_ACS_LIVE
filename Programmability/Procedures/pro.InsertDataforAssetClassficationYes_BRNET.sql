...
create PROCEDURE [pro].[InsertDataforAssetClassficationYes_BRNET]
--@TIMEKEY INT 
WITH RECOMPILE
AS
BEGIN 
...
Declare  @Timekey1 int
	select  @Timekey1=timekey from SysDayMatrix where Date =@StartDt
		...
		update YBL_ACS_MIS..ACCOUNTDATA set AssetClass ='WRITEOFF' where sourcesystemname ='GANASEVA' and AssetClass ='WRITTEN-OFF'
				...
				----- Added By Sourangshu BR.NET
		update YBL_ACS_MIS_UAT..ACCOUNTDATA 
		set AssetClass ='WRITEOFF' 
		where 
		sourcesystemname ='BR.NET' 
...
WHERE B.Restr_Flag='Y' and a.Asset_Norm <> 'ALWYS_STD'
