...
CREATE PROCEDURE [pro].[DATATOCLIENTDEGRADENPA]
AS
BEGIN
...
DELETE  FROM  PRO.DATATOCLIENT_DEGRADENPA WHERE TIMEKEY=@TIMEKEY 

INSERT INTO  PRO.DATATOCLIENT_DEGRADENPA
...
WHERE  A.FinalAssetClassAlt_Key>=2 
