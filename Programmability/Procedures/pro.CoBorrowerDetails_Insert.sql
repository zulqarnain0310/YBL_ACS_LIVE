USE [YBL_ACS]
GO
/****** Object:  StoredProcedure [pro].[CoBorrowerDetails_Insert]    Script Date: 7/14/2025 11:07:55 AM ******/
SET ANSI_NULLS ON
GO
...
alter PROC [pro].[CoBorrowerDetails_Insert] 
...
IF OBJECT_ID('TEMPDB..#PrimaryUPGData') IS NOT NULL
  ...
  and b.UPGDate is null
	...
	IF @TIMEKEY =26851--26886 /* update FlgDeg ='Y' NAD deGdaTE AS fINALnPADATE FOR THE NPA ACCOUNT WHEN CO-BORROWER IMPLEMENTATION - TO BE EXECUTE ONLY ONCE */
		...
		/*TO HANDLE 490 ACCOUNTS OF COBORROWER ON 2025-06-04*/
			...
			WHERE C.EffectiveFromTimeKey<=27548-1 AND C.EffectiveToTimeKey>=27548-1
				AND B.EffectiveFromTimeKey<=27548 AND B.EffectiveToTimeKey>=27548
		...
		/*TO HANDLE 490 ACCOUNTS OF COBORROWER ON  2025-06-04 END*/
