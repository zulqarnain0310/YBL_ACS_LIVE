...
GO
 ...
 /*===========================================
   ...
   DESCRIPTION : DEMAND RECOVERY SET OFF
    ================================================*/
CREATE PROCEDURE [dbo].[DmdRecoSetOffLogicCC_Seg01BackupBeforeNewImplement]    
                                            -- (   
              --@TimeKey INT  
            --,@UCIF_ID VARCHAR(30)  
           -- )  
                     ...
                     -- Update Recovery date, Adjustment data and Recovery amount  
                      ...
                      -- If the excess demand has found then insert a new row for excess demand   
                        ...
                        BEGIN  
                           ...
                           INSERT INTO AdvAcCCDemandDetail_Seg01(customerid,DemandType,DemandDate,DemandAmt,RecDate,RecAdjDate,RecAmount,BalanceDemand,DmdSchNumber,AcType,UCIF_ID)  
