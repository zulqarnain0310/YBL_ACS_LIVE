...
CREATE PROCEDURE [pro].[InsertDataforAssetClassficationYes_old]
--@TIMEKEY INT 
WITH RECOMPILE
AS
BEGIN 
...
----AND DATEADD(DAY,90,A.DEBITSINCEDT)<@PROCESSINGDATE AND A.DEBITSINCEDT IS NOT NULL AND Asset_Norm<>'ALWYS_STD' ----FirstDtOfDisb 
---- AND C.EFFECTIVEFROMTIMEKEY<=@TIMEKEY AND C.EFFECTIVETOTIMEKEY>=@TIMEKEY
