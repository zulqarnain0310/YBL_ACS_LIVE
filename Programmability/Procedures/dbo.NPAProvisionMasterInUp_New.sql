...
CREATE PROC [dbo].[NPAProvisionMasterInUp_New]
...
------------Added for Rejection Screen  29/06/2020   ----------
		...
		DECLARE			@Uniq_EntryID			int	= 0
						...
						,@VisionPlusResultMsg	Varchar(500) = NULL
...
Declare @VisionPlusMsg varchar(500)
			...
			BEGIN
				...
				ELSE ---IF DATA IS AVAILABLE IN MAIN TABLE
					...
					BEGIN	
						...
						print @UpperDPD_VisionPlus_SUB_0
						set @VisionPlusMsg='Please change VisionPlus_SUB_1 Lower DPD  to ' + cast (@UpperDPD+1 as varchar(10))
						SET @ResultMsg= @VisionPlusMsg --+ cast (@UpperDPD_VisionPlus_SUB_0+1  as varchar(3))
						----select @ResultMsg	
