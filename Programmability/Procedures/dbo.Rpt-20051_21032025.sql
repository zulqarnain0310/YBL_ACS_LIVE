...
--USE [YBL_ACS]
--GO
--/****** Object:  StoredProcedure [dbo].[Rpt-20051]    Script Date: 21-Mar-25 10:39:53 AM ******/
--SET ANSI_NULLS ON
--GO
...
CREATE PROC [dbo].[Rpt-20051_21032025]    
  @TimeKey AS INT  
,@Cost    AS FLOAT  
AS   
...
Select  A.ValuationDate, A.DISBURSALDATE,CustomerAcID,C.EffectiveFromTimeKey,C.EffectiveToTimeKey into #TempTable from AdvSecurityValueDetail  A 
...
ACH.CustomerAcID                          As [Account ID],
CCH.CustomerName,  
CCH.PANNO,  
