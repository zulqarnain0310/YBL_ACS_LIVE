...
CREATE PROC [dbo].[CCOD_InttDemandServiceBackDtData]
 @date DATE
AS
...
IF OBJECT_ID('tempdb..#AcDailyTxnDetail') IS NOT NULL
	...
	Inner join SysDayMatrix c
	on b.EffectiveFromTimeKey=c.TimeKey

           where B.ProductCode in('660','661','889','681','682','693','694','695','696','715','716','717','718',
			     '755','756','757','758','763','764','765','766','787','788','789','795','796',
			     '797','798','799','220','237','740','778')
...
--UPDATE A SET TrueCredit=B.SrcSysMnemonicCode
--FROM #AcDailyTxnDetail A
--INNER  JOIN DIMMNEMONICCODE B ON A.MNEMONICCODE B.MNEMONICCODE
