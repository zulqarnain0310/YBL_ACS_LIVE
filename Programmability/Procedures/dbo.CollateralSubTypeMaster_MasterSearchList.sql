...
--sp_rename 'CollateralSubTypeMaster_MasterSearchList','CollateralSubTypeMaster_MasterSearchList_04052022'
---
--USE YES_MISDB
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
CREATE PROC [dbo].[CollateralSubTypeMaster_MasterSearchList]
--Declare
           ...
           A.EffectiveToTimeKey, 
                  ...
                  A.DateModified
                     ...
                     FROM DimCollateralSubType_Mod A
                           ...
                           AND A.CollateralSubTypeAltKey IN
                     (
                         SELECT MAX(CollateralSubTypeAltKey)
