...
CREATE PROCEDURE [CURDAT].[AdvFacECFSDetail_INSERT_DATA]
AS
BEGIN
   DECLARE @TIMEKEY INT=(SELECT TimeKey FROM YBL_ACS.PRO.EXTDATE_MISDB WHERE Flg='Y')


   DELETE  FROM  CURDAT.AdvFacECFSDetail WHERE EffectiveFromTimeKey=@TIMEKEY and EffectiveToTimeKey=@TIMEKEY

 

INSERT INTO YBL_ACS.CURDAT.AdvFacECFSDetail
(
AccountEntityId
,ECFSBRANCHCODE
,ECFSREFCUSTOMERID
...
from YBL_ACS_MIS.[DBO].[AccountData]  A
