...
CREATE PROC [dbo].[NPAProvisionMasterInUp_beforeUatDeployment_bkp]
...
print @TIMEKEY
Declare @LowerDPD_VisionPlus_SUB_0 int=(SELECT LowerDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_0' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @UpperDPD_VisionPlus_SUB_0 int=(SELECT UpperDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_0' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @LowerDPD_VisionPlus_SUB_1 int=(SELECT LowerDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_1' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @UpperDPD_VisionPlus_SUB_1 int=(SELECT UpperDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_1' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @LowerDPD_VisionPlus_SUB_2 int=(SELECT LowerDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_2' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @UpperDPD_VisionPlus_SUB_2 int=(SELECT UpperDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_2' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @LowerDPD_VisionPlus_SUB_3 int=(SELECT LowerDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_3' AND EFFECTIVETOTIMEKEY=49999)		--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
Declare @UpperDPD_VisionPlus_SUB_3 int=(SELECT UpperDPD FROM DIMPROVISION_SEG WHERE PROVISIONNAME='VisionPlus_SUB_3' AND EFFECTIVETOTIMEKEY=49999)	--AND EFFECTIVEFROMTIMEKEY <=@TIMEKEY AND EFFECTIVETOTIMEKEY >=@TIMEKEY)              
print 'BB'
		...
		BEGIN
			...
			BEGIN
				...
				ELSE ---IF DATA IS AVAILABLE IN MAIN TABLE
					...
					IF @OperationFlag=2
					BEGIN	
					print 'VisionPlus_SUB_0'
						IF @ProvisionName='VisionPlus_SUB_0'  AND @UpperDPD_VisionPlus_SUB_1<>@UpperDPD+1
						Begin
						print 'VisionPlus_SUB_0'
					
						
						SET @ResultMsg= 'Please change VisionPlus_SUB_1 Lower DPD  to ' + cast (@UpperDPD+1 as varchar(10))
						----select @ResultMsg	
							
						End

						IF @ProvisionName='VisionPlus_SUB_1'  AND (@UpperDPD_VisionPlus_SUB_0<>@LowerDPD-1 OR @LowerDPD_VisionPlus_SUB_2<>@UpperDPD+1)
						Begin						
							print 'VisionPlus_SUB_1'
						
							SET @ResultMsg= 'Please change VisionPlus_SUB_0 Upper DPD  to ' + cast (@LowerDPD-1 as varchar(10)) +' & VisionPlus_SUB_2 Lower DPD to '+cast (@UpperDPD+1 as varchar(10))
						----select @ResultMsg	
							
						End

						IF @ProvisionName='VisionPlus_SUB_2'  AND (@UpperDPD_VisionPlus_SUB_1<>@LowerDPD-1 OR @LowerDPD_VisionPlus_SUB_3<>@UpperDPD+1)
						Begin						
							print 'VisionPlus_SUB_2'
						
						
							SET @ResultMsg= 'Please change VisionPlus_SUB_1 Upper DPD to ' + cast (@LowerDPD-1 as varchar(10)) +' & VisionPlus_SUB_3 Lower DPD to '+cast (@UpperDPD+1 as varchar(10))
						----select @ResultMsg	
							
						End

						IF @ProvisionName='VisionPlus_SUB_3'  AND @UpperDPD_VisionPlus_SUB_2<>@LowerDPD-1
						Begin						
							print 'VisionPlus_SUB_3'
						
						
							SET @ResultMsg= 'Please change VisionPlus_SUB_2 Upper DPD to ' + cast (@LowerDPD-1 as varchar(10))
						----select @ResultMsg	
								...
								IF EXISTS(SELECT 1 FROM DimProvision_Seg WHERE (EffectiveFromTimeKey<=@TimeKey AND EffectiveToTimeKey>=@TimeKey) 
									...
									BEGIN
										...
										UPDATE DimProvision_Seg SET
												...
												,ProvisionShortNameEnum=@FacilityType
...
from (
 ...
 SET @FinalParameter3 = (select STUFF((	SELECT Distinct ',' + Items from #AA  for XML PATH('')),1,1,''))
	...
	-------------------
PRINT 7
print isnull(@IsSCD2,'n')
print @ProvisionAlt_Key
print @timekey
		COMMIT TRANSACTION
