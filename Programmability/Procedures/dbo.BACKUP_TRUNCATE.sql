...
GO
CREATE PROCEDURE [dbo].[BACKUP_TRUNCATE]
AS
...
DECLARE @TAB5 VARCHAR(50)=' FROM YBL_ACS..AdvSecurityDetail'
DECLARE @TAB6 VARCHAR(50)=' FROM YBL_ACS..AdvSecurityValueDetail'
...
TRUNCATE TABLE YBL_ACS..AdvSecurityDetail

TRUNCATE TABLE YBL_ACS..AdvSecurityValueDetail
