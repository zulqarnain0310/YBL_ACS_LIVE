...
create procedure [pro].[InsertDataIntoHistTable_account_purge]
@TIMEKEY int
with recompile
as
begin
 ...
 DELETE  FROM  pro.Accountcal_Histnew WHERE EffectiveFromTimeKey=@TIMEKEY and EffectiveToTimeKey=@TIMEKEY
 
insert into pro.Accountcal_Histnew
(
AccountEntityID
,UcifEntityID
,CustomerEntityID
