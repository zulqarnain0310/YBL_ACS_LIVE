...
CREATE PROC [dbo].[Rpt-20051_11042025]    
  @TimeKey AS INT  
,@Cost    AS FLOAT  
AS   
...
----INNER JOIN AdvSecurityDetail B          ON ACH.CustomerAcID=B.RefSystemAcId 
----                                        AND B.EffectiveFromTimeKey<=@TimeKey 
----										AND B.EffectiveToTimeKey>=@TimeKey   

----INNER JOIN AdvSecurityValueDetail C     ON B.SecurityEntityID=C.SecurityEntityID 
...
WHERE  ACH.FinalAssetClassAlt_Key>1 and  ProductErosion='Y' ----ACH.SourceAlt_Key in (1,2)  
